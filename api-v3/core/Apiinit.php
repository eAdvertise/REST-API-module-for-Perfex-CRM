...
// Defensive duplicate of the guard in api.php: silence the bundled rmccue/requests
// PSR-0 deprecation shim before the Composer autoloader (and its legacy `Requests`
// classmap) load, in case this class is bootstrapped via a path that reaches the
// autoloader before api.php's guard runs.
