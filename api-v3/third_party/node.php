...
if(!defined('UPDATE_INFO_POINT'))
	define('UPDATE_INFO_POINT', 'https://envato.toofasthost.com/api/updateinfo');
// Legacy token-fetch define removed: verification is now fully server-side.
?>