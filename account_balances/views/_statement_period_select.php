<?php $hll_default_period_val = !empty( $default_value ) ? $default_value : 'all' ; ?>
<div class="form-group select-placeholder">
    <select
        ...
        <option value='<?php echo json_encode(
            ...
            )); ?>' <?php echo $hll_default_period_val == 'all' ? 'selected' : ''?> > <?php echo _l('all')?></option>
        ...
        <option value='<?php echo json_encode(
            array(
                _d(date('Y-m-d')),
                _d(date('Y-m-d'))
            )); ?>' <?php echo $hll_default_period_val == 'today' ? 'selected' : ''?> >
            <?php echo _l('today'); ?>
        </option>
        <option value='<?php echo json_encode(
            array(
