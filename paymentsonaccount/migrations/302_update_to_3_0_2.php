...
/**
 * Module upgrade script for version 3.0.2.
 *
 * - Ensures the editable receipt email template exists.
 * - Marks installations that include the receipt email delivery fix.
 */
class Migration_Version_302 extends App_module_migration
{
    public function up()
    {
        if (function_exists('paymentsonaccount_apply_3_0_2_database_updates')) {
