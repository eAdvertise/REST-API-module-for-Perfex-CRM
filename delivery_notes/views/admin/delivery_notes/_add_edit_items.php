...
$rate_class = delivery_note_item_field_hidden('rate') ? '' : '';
$tax_class = delivery_note_item_field_hidden('tax') ? '' : '';
$amount_class = delivery_note_item_field_hidden('amount') ? '' : '';
?>
    ...
    <div class="table-responsive s_table">
        <table class="table delivery_note-items-table items table-main-delivery_note-edit has-calculations no-mtop">
            <thead>
                <tr>
                    <th></th>
                    <th align="left"><i class="fa-solid fa-circle-exclamation tw-mr-1"
                            data-toggle="tooltip"
