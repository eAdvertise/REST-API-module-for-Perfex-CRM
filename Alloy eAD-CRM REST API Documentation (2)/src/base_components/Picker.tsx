...
interface Result {
  id: string
  name: string
  submenuItems?: Array<ComponentResult>
  onSelect?: () => void
  isSelected?: boolean
  selectable?: boolean
  type?: 'result'
...
type SearchResult = (ComponentResult & { searchStrings: Array<string>; searchId: string }) | Divider
...
interface CommonPickerProps {
  ...
  results: Array<TextResult> | Array<ComponentResult> | Array<SearchResult>
  placeholder?: string
...
type PickerProps =
  | (CommonPickerProps & {
      ...
      onResultsSelected: (ids: Array<string>, id: string, close: boolean) => void
    })
  | (CommonPickerProps & {
      selectType?: 'single'
...
const recursivelyFilterBySearch: (
  ...
  search: string,
  callLimit?: number,
) => Array<SearchResult> = (result: Result | Divider, search: string, callLimit: number = 20) => {
...
interface PickerResultProps {
  ...
  onResultsSelected: (ids: Array<string>) => void
  isSelected: boolean
  setSvgFill?: boolean
    ...
    >
      ...
      {submenuOpen && (
        <HierarchyPicker
          ...
          onResultsSelected={(ids: Array<string>) => {
...
const PickerTextRenderer = (props: { text: string; searchStrings?: Array<string> }) => {
